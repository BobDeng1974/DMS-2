...
int main(int argc, char *argv[]) {
    try {
        ...
        std::vector<std::pair<std::string, std::string>> cmdOptions = {
            ...
            {FLAGS_d_em, FLAGS_m_em}, {FLAGS_d_lm, FLAGS_m_lm}, {FLAGS_d_ps, FLAGS_m_ps}
        };
        ...
        PhoneSmokeDetection phoneSmokeDetector(FLAGS_m_ps, FLAGS_d_ps, 1, false, FLAGS_async, FLAGS_t, FLAGS_r);
        ...
        Load(phoneSmokeDetector).into(pluginsForDevices[FLAGS_d_ps], false);
        ...
        // bool isPhoneSmokeEnabled = phoneSmokeDetector.enabled();
        ...
        while (true) {
            ...
            std::cout << "faces : " << prev_detection_results.size() << std::endl;
            ...
            // Filling inputs of phone smoke detection networks
            if(!prev_detection_results.empty()){
                ...
                phoneSmokeDetector.fetchResults();
            }
