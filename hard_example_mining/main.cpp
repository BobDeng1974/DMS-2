...
const std::string root_path = "/home/yang/dataset/hard_images/";
...
int main(int argc, char *argv[]) {
    try {
        ...
        for(size_t i = 0;i < images.size();i++) {
            ...
            std::cout << " img : "<< images[i] << std::endl;
            cv::Mat curr_frame = cv::imread(images[i]);
            const size_t width  = (size_t) curr_frame.cols;
            const size_t height  = (size_t) curr_frame.rows;
            frameToBlob(curr_frame, infer_request, inputName);
            ...
            for (int i = 0; i < maxProposalCount; i++) {
                ...
                if (confidence > FLAGS_t) {
                    ...
                    cv::putText(curr_frame,
                                ...
                                labels[label] : std::to_string(label)) + conf.str(),
            ...
            // const std::string imgName = root_path + "out_" + std::to_string(i) + ".jpg";
            size_t pos = root_path.size();
            const std::string imgName = root_path + images[i].substr(pos - 1, images[i].size());
            cv::imwrite(imgName, curr_frame);
